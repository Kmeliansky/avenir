...
export default function Hero({ title = "Engenharia Reversa" }: HeroProps) {
  return (
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 md:grid-cols-2 md:gap-12">
        ...
        <SectionReveal from="left">
          ...
          <p className="mb-8 text-[17px] font-medium text-zinc-300">
            Fazemos a reconstrução digital de peças, componentes e sistemas, com fidelidade dimensional e preparação para melhorias ou fabricação. É a soma da digitalização com a modelagem 3D.
          </p>
