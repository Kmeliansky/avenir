...
export default function Hero({ title = "Fabricação de Peças de uso final" }: HeroProps) {
  return (
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 md:grid-cols-2 md:gap-12">
        ...
        <SectionReveal from="left">
          ...
          <p className="mb-8 text-[17px] font-medium text-zinc-300">
            Fabricamos componentes e peças de uso final sob demanda, desde peças únicas até grandes lotes através da manufatura aditiva ou de processos híbridos.
          </p>
