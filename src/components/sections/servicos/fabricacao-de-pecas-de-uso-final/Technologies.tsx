...
const tools = [
  {
    ...
    desc: "Tecnologia utilizada na fabricação de peças funcionais com ótimo custo-benefício, ideal para componentes técnicos e aplicações industriais.",
    icon: "/images/modelagem-3d/icone-software-de-modelagem-3d.svg",
  },
  {
    title: "Impressão 3D MJF",
    desc: "Processo indicado para produção de peças com maior resistência mecânica, precisão dimensional e qualidade superficial.",
    icon: "/images/modelagem-3d/icone-tolerancias-e-ajustes-dimensionais.svg",
  },
  {
    title: "Impressão 3D DLP",
    desc: "Aplicada na fabricação de componentes com alto nível de detalhe, acabamento refinado e geometrias complexas.",
    icon: "/images/modelagem-3d/icone-formatos-de-entrega.svg",
  },
  {
    title: "Modelagem CAD 3D",
    desc: "Utilização de softwares CAD para desenvolvimento, ajustes técnicos e preparação de arquivos para fabricação.",
    icon: "/images/modelagem-3d/icone-experiencias-com-materiais.svg",
  },
  {
    title: "Processos Complementares",
    desc: "Integração entre manufatura aditiva e outros processos produtivos para otimização de acabamento, desempenho e aplicação final das peças.",
      ...
      <div className="mx-auto max-w-7xl">
        <SectionReveal from="left">
          ...
          <p className="max-w-xl text-[17px] font-medium text-zinc-300">
            A fabricação de peças de uso final utiliza tecnologias de manufatura aditiva e processos complementares para produzir componentes funcionais com precisão, flexibilidade e redução de etapas produtivas. Esse modelo permite fabricar peças sob demanda sem necessidade de ferramental convencional, atendendo diferentes aplicações industriais.          </p>
          </div>
        </SectionReveal>
