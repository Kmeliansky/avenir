...
const applications = [
  {
    ...
    desc: "Suporte técnico na criação, adaptação e validação de novos produtos para diferentes aplicações industriais.",
    icon: "product",
  },
  {
    title: "Redução de Custos",
    desc: "Análise de processos e componentes para identificar alternativas mais econômicas de fabricação.",
    icon: "printer",
  },
  {
    title: "Escolhas de Tecnologias",
    desc: "Definição das tecnologias mais adequadas para prototipagem, produção ou testes funcionais.",
    icon: "engineering",
  },
  {
    title: "Melhoria de Componentes",
    desc: "Avaliação técnica de peças para otimização estrutural, funcional ou produtiva.",
    icon: "presentation",
  },
  {
    title: "Validação de Projetos",
    desc: "Apoio técnico para testes, análises e tomada de decisão antes da fabricação em escala.",
    icon: "validation",
  },
  {
    title: "Produção Sob demanda",
    desc: "Estruturação de estratégias para fabricação sob demanda com manufatura aditiva e processos híbridos.",
    icon: "digital",
  },
]
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <SectionReveal from="left">
          <h2 className="mb-12 text-center text-3xl md:text-h2">
            Aplicações da nossa Consultoria
          </h2>
        </SectionReveal>
