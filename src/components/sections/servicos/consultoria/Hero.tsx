...
export default function Hero({ title = "Consultoria" }: HeroProps) {
  return (
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 md:grid-cols-2 md:gap-12">
        ...
        <SectionReveal from="left">
          ...
          <p className="mb-8 text-[17px] font-medium text-zinc-300">
            Oferecemos suporte técnico especializado em projetos, processos (tecnologias), escolha de materiais e fabricação de produtos com a manufatura aditiva.
          </p>
