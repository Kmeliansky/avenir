...
const applications = [
  {
    ...
    desc: "Modelagem 3D para transformar ideias em produtos viáveis, com validação de forma, proporção e funcionamento antes da produção.",
    icon: "product",
  },
  {
    title: "Prototipagem e Impressão 3D",
    desc: "Modelos otimizados para manufatura aditiva, considerando orientação de impressão, suportes e tolerâncias específicas de cada processo.",
    icon: "printer",
  },
  {
    title: "Peças Técnicas e Engenharia",
    desc: "Modelagem dimensional precisa de peças mecânicas, estruturais e de encaixe, com foco em funcionalidade e viabilidade de fabricação.",
    icon: "engineering",
  },
  {
    title: "Apresentação de Projetos",
    desc: "Modelos 3D detalhados para visualização e apresentação de projetos, com acabamento adequado para renders e materiais visuais.",
    icon: "presentation",
  },
  {
    title: "Simulação e Validação",
    desc: "Modelos preparados para análise de interferências, simulação de montagem e validação de conceito antes do investimento em fabricação.",
    icon: "validation",
  },
  {
    title: "Modelagem Digital",
    desc: "Criação de modelos 3D para uso em ambientes digitais, como catálogos, personagens, apresentações e integrações em sites. Ideal para demonstrar produtos e conceitos sem depender de protótipos físicos.",
    icon: "digital",
  },
]
