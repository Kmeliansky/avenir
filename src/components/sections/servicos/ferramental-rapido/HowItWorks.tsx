      ...
      <div className="mx-auto max-w-7xl">
        ...
        <SectionReveal from="left">
          ...
          <p className="text-[17px] font-medium text-zinc-300">
            O ferramental rápido consiste na fabricação de moldes, gabaritos e dispositivos utilizando manufatura aditiva, reduzindo o tempo de desenvolvimento e viabilizando ajustes rápidos. As tecnologias utilizadas incluem MEx, DLP e outras tecnologias conforme a aplicação. É indicado para testes, validações e produção de pequenos lotes sem a necessidade de processos convencionais de usinagem.
          </p>
          </div>
        </SectionReveal>
