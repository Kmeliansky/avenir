...
export default function Hero({ title = "Lote Piloto" }: HeroProps) {
  return (
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 md:grid-cols-2 md:gap-12">
        ...
        <SectionReveal from="left">
          ...
          <p className="mb-8 text-[17px] font-medium text-zinc-300">
            Produzimos pequenas séries para validação de engenharia, testes de mercado ou preparação para fabricação em escala.
          </p>
