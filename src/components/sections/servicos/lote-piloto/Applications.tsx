...
const applications = [
  {
    title: "Validação de Produtos",
    desc: "Produção de pequenas séries para validar desempenho, funcionalidade e aplicação do produto em uso real.",
    icon: "product",
  },
  {
    title: "Testes Comerciais",
    desc: "Lotes utilizados para apresentações, pré-vendas, testes de aceitação e análise de mercado.",
    icon: "printer",
  },
  {
    title: "Ajustes de Engenharia",
    desc: "Avaliação técnica de peças e componentes para identificar melhorias antes da produção em escala.",
    icon: "engineering",
  },
  {
    title: "Homologação de Componentes",
    desc: "Fabricação de unidades para testes técnicos, aprovação de projeto e processos de homologação.",
    icon: "presentation",
  },
  {
    title: "Pré-Produção Industrial",
    desc: "Etapa intermediária para validar materiais, processos produtivos e estratégia de fabricação.",
    icon: "validation",
  },
  {
    title: "Desenvolvimento de Startups",
    desc: "Produção inicial de produtos para startups e empresas que precisam validar soluções com baixo volume.",
    icon: "digital",
  },
]
