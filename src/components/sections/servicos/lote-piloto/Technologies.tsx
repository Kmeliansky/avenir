...
const tools = [
  {
    ...
    desc: "Aplicamos tecnologias de impressão 3D para fabricação rápida de pequenas séries com flexibilidade produtiva e redução de tempo no desenvolvimento.",
    icon: "/images/modelagem-3d/icone-software-de-modelagem-3d.svg",
  },
  {
    title: "Modelagem CAD 3D",
    desc: "Utilizamos softwares CAD 3D para ajustes técnicos, preparação de arquivos e validação dimensional das peças produzidas.",
    icon: "/images/modelagem-3d/icone-tolerancias-e-ajustes-dimensionais.svg",
  },
  {
    title: "Prototipagem Funcional",
    desc: "Produção de componentes para testes de montagem, desempenho mecânico, encaixe e validação em condições reais de uso.",
    icon: "/images/modelagem-3d/icone-formatos-de-entrega.svg",
  },
  {
    title: "Injeção Plástica de Bancada",
    desc: "Processo complementar utilizado em alguns projetos para validação inicial de peças plásticas em pequenas quantidades.",
    icon: "/images/modelagem-3d/icone-experiencias-com-materiais.svg",
  },
  {
    title: "Engenharia de Produto",
    desc: "Análise técnica voltada para materiais, funcionalidade, desempenho e preparação do produto para futura produção em escala.",
      ...
      <div className="mx-auto max-w-7xl">
        <SectionReveal from="left">
          ...
          <p className="max-w-xl text-[17px] font-medium text-zinc-300">
            A produção de lote piloto utiliza diferentes tecnologias para validar produtos em pequena escala antes da fabricação definitiva. Esse processo permite testar desempenho, funcionalidade, aceitação de mercado e viabilidade produtiva com mais segurança e menor custo inicial.
          </p>
          </div>
        </SectionReveal>
