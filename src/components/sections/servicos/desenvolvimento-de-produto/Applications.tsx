...
const applications = [
  {
    ...
    desc: "Criação de produtos do zero com foco técnico, funcional e preparação para fabricação industrial.",
    icon: "product",
  },
  {
    title: "Melhoria de Componentes",
    desc: "Redesenho e otimização de peças para aumentar desempenho, resistência ou eficiência produtiva.",
    icon: "printer",
  },
  {
    title: "Adaptação de Produtos",
    desc: "Adequação de componentes e sistemas para novas aplicações, processos ou necessidades específicas.",
    icon: "engineering",
  },
  {
    title: "Prototipagem Funcional",
    desc: "Desenvolvimento de protótipos para testes, validações e análise de desempenho antes da produção.",
    icon: "presentation",
  },
  {
    title: "Fabricação Sob Demanda",
    desc: "Projetos preparados para produção personalizada e fabricação sob demanda com manufatura aditiva.",
    icon: "validation",
  },
  {
    title: "Soluções para Indústria",
    desc: "Desenvolvimento técnico de peças, dispositivos e componentes para diferentes setores industriais.",
    icon: "digital",
  },
]
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <SectionReveal from="left">
          <h2 className="mb-12 text-center text-3xl md:text-h2">
            Aplicações do Desenvolvimento de Produto
          </h2>
        </SectionReveal>
