...
export default function Hero({ title = "Desenvolvimento de Produto" }: HeroProps) {
  return (
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 md:grid-cols-2 md:gap-12">
        ...
        <SectionReveal from="left">
          ...
          <p className="mb-8 text-[17px] font-medium text-zinc-300">
            Desenvolvemos e aprimoramos produtos sob medida, com foco técnico e funcional, desde a ideia até o projeto final para fabricação industrial.
          </p>
