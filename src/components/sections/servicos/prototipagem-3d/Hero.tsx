...
export default function Hero({ title = "Prototipagem 3D" }: HeroProps) {
  return (
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 md:grid-cols-2 md:gap-12">
        ...
        <SectionReveal from="left">
          ...
          <p className="mb-8 text-[17px] font-medium text-zinc-300">
            Fabricamos protótipos funcionais ou visuais para testes e validações, reduzindo riscos antes da produção final.
          </p>
