...
const applications = [
  {
    ...
    desc: "Produção de modelos físicos para validar ideias, formatos e funcionalidades antes do desenvolvimento final.",
    icon: "product",
  },
  {
    title: "Testes de Montagem",
    desc: "Prototipagem de peças e conjuntos para verificar encaixes, tolerâncias e compatibilidade entre componentes.",
    icon: "printer",
  },
  {
    title: "Avaliação Funcional",
    desc: "Fabricação de protótipos para testes mecânicos, ergonômicos e análise de desempenho em uso real.",
    icon: "engineering",
  },
  {
    title: "Desenvolvimento de Produtos",
    desc: "Aplicação da prototipagem 3D em etapas de criação, melhoria e validação técnica de novos produtos.",
    icon: "presentation",
  },
  {
    title: "Apresentações Comerciais",
    desc: "Produção de modelos para demonstrações, feiras, apresentações técnicas e validação com clientes.",
    icon: "validation",
  },
  {
    title: "Redução de Riscos de Projeto",
    desc: "Identificação antecipada de falhas, ajustes necessários e melhorias antes da fabricação definitiva.",
    icon: "digital",
  },
]
