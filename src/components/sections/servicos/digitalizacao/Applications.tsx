...
const applications = [
  {
    title: "Reprodução de Peças",
    desc: "Digitalização de componentes físicos para fabricação de novas peças sem necessidade de projeto original.",
    icon: "product",
  },
  {
    title: "Engenharia Reversa",
    desc: "Conversão de peças em modelos digitais para reconstrução técnica, ajustes e melhorias de projeto.",
    icon: "printer",
  },
  {
    title: "Controle Dimensional",
    desc: "Captura e análise de medidas para verificação dimensional, inspeção e comparação técnica de componentes.",
    icon: "engineering",
  },
  {
    title: "Digitalização de Componentes Antigos",
    desc: "Conversão de peças sem documentação técnica em arquivos digitais para armazenamento e reutilização futura.",
    icon: "presentation",
  },
  {
    title: "Integração com CAD 3D",
    desc: "Preparação de modelos digitais para edição, modelagem técnica e desenvolvimento de projetos em softwares CAD.",
    icon: "validation",
  },
  {
    title: "Preparação para Fabricação",
    desc: "Geração de arquivos digitais para prototipagem, impressão 3D e processos de fabricação industrial.",
    icon: "digital",
  },
]
