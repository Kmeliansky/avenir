...
export default function Hero({ title = "Inventário Digital" }: HeroProps) {
  return (
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 md:grid-cols-2 md:gap-12">
        ...
        <SectionReveal from="left">
          ...
          <p className="mb-8 text-[17px] font-medium text-zinc-300">
            Organização e digitalização de peças de reposição, com identificação de componentes viáveis para fabricação por manufatura aditiva e estruturação de um acervo digital para produção sob demanda.
          </p>
