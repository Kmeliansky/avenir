      ...
      <div className="mx-auto max-w-7xl">
        ...
        <SectionReveal from="left">
          ...
          <p className="text-[17px] font-medium text-zinc-300">
            Na AVENIR 3D, o serviço de modelagem 3D é estruturado para dar clareza técnica em cada etapa do projeto. Nosso foco é transformar sua necessidade em um modelo digital funcional, pronto para validação, apresentação ou fabricação.
          </p>
          </div>
        </SectionReveal>
