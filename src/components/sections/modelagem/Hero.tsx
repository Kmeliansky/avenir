...
export default function Hero({ title = "Modelagem 3D para projetos técnicos e industriais" }: HeroProps) {
  return (
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 md:grid-cols-2 md:gap-12">
        ...
        <SectionReveal from="left">
          ...
          <p className="mb-8 text-[17px] font-medium text-zinc-300">
            Modelagem 3D de geometrias tridimensionais em software CAD, usada para criar, ajustar ou preparar peças para impressão. Desenvolvida com foco funcional, considerando uso final e processo de fabricação.
          </p>
